...
workflow boltonlab_CH_annotation {
    input {      
        ...
        File mutect_pon2_annotated_vcf
        File mutect_pon2_annotated_vcf_tbi
        File vardict_pon2_annotated_vcf
        File vardict_pon2_annotated_vcf_tbi
        File lofreq_pon2_annotated_vcf
        File lofreq_pon2_annotated_vcf_tbi
    ...
    scatter (caller_vcf in [mutect_pon2_annotated_vcf, vardict_pon2_annotated_vcf, lofreq_pon2_annotated_vcf]){
    ...
    call mergeVcf as mergeCallers {
        ...
        call annotateVcf as mutect_annotate_vcf {
            input:
            vcf = mutect_pon2_annotated_vcf,
            vcf_tbi = mutect_pon2_annotated_vcf_tbi,
        ...
        call annotateVcf as vardict_annotate_vcf {
            input:
            vcf = vardict_pon2_annotated_vcf,
            vcf_tbi = vardict_pon2_annotated_vcf_tbi,
            fp_filter = fpFilter_filtered_vcf,
            fp_filter_tbi = fpFilter_filtered_vcf_tbi,
            vep = vep.annotated_vcf,
            vep_tbi = vep.annotated_vcf_tbi,
        ...
        call annotateVcf as lofreq_annotate_vcf {
            input:
            vcf = lofreq_pon2_annotated_vcf,
            vcf_tbi = lofreq_pon2_annotated_vcf_tbi,
            fp_filter = fpFilter_filtered_vcf,
            fp_filter_tbi = fpFilter_filtered_vcf_tbi,
            vep = vep.annotated_vcf,
            vep_tbi = vep.annotated_vcf_tbi,
